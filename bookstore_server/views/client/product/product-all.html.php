                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="product-m">
                                    <div class="product-m__thumb">
                                        ...
                                        <a class="aspect aspect--bg-grey aspect--square u-d-block" href="/product/product-detail">
                                    ...
                                    <div class="product-m__content">
                                        <div class="product-m__category">
                                            ...
                                            <a href="shop-side-version-2.html"><?= $product->get_category_name() ?></a></div>
                                        <div class="product-m__name">

                                            <a href="/product/product-detail"><?= $product->name ?></a></div>
